...
class Skeleton extends CommandPart {
	...
	private $skeleton = array(
		...
		array( 6, './includes/', 'Direcotory for your custom PHP files.' ),
		array( 7, './page-templates/', 'Direcotory for custom WP templates.' ),
		array( 8, './template-parts/', 'Direcotory for the WP default template parts.' ),
		array( 9, './home.php', 'This template is used to render the blog posts index.' ),
		array( 10, './front-page.php', 'This template is used to render your site’s front page.' ),
		array( 11, './privacy-policy.php', 'This template is used to render your site’s Privacy Policy page.' ),
		array( 12, './singular.php', 'This template is used to backup single & page templates if one of them is not existed.' ),
		array( 13, './single.php', 'This template is used to render a single post.' ), // custom post type
		array( 14, './page.php', 'This template is used to render a static page (page post-type).' ),
		array( 15, './archive.php', 'This template is used to render  archive index pages.' ),
		array( 16, './category.php', 'This template is used to render category archive index pages.' ),
		array( 17, './tag.php', 'This template is used to render tag archive index pages.' ),
		array( 18, './author.php', 'This template is used to render author archive index pages.' ),
		array( 19, './date.php', 'This template is used to render archive index pages by date.' ),
		array( 20, './searchpage.php', 'This template is used to render the search page.' ),
		array( 21, './search.php', 'This template is used to render the search results in the Search Template.' ),
		array( 22, './404.php', 'This template is used to render the 404 template.' ),
		array( 23, './header.php', 'This template is used to render theme\'s header.' ),
		array( 24, './footer.php', 'This template is used to render theme\'s footer.' ),
		array( 25, './assets/js/custom.js', 'This template is used to render theme\'s footer.' ),
	);
